...
1. [Murderbot Diaries (Book 8): Platform Decay](https://bookshop.org/a/5270/9781250827005), by Martha Wells ++
   <details><summary>It's been two years since the seventh installment...</summary>It's been two years since the seventh installment of The Murderbot Diaries, <strong>System Collapse</strong> and the eighth book, <strong>Platform Decay</strong>strong>, doesn't disappoint. Differing from most of the previous books, our favorite sarcastic, self-aware SecUnit (security unit) is leading this adventure into unknown territory, rather than reacting to circumstances in which it finds itself. The storyline is dynamic and fun, and Murderbot's narrative dialog is still sarcastically descriptive, just as I like it. See my [Top reads of 2020](/reads/top-reads-2020/).<br><br></details>
